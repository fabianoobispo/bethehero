...
export default function Detail() {
  ...
  const mesage = `Olá ${incident.name}, estou entrando em contado pois gostaria de ajudar no caso "${incident.title}" com o valor de ${Intl.NumberFormat('pt-BR', {
    style: 'currency', 
  ...
  <Text style={styles.incidentValue}>{incident.name} de {incident.city}-{incident.uf}</Text>
          ...
          <Text style={styles.incidentProperty}>VLOR:</Text>
